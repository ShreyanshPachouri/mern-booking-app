...
const SearchBar = () => {
    ...
    //When the user types in the search fields, the data will be stored in the local state variable declared here, once the user clicks the submit button, the data will be transferred to the global state variable (search).
